import 'AutoGenerateValue.dart';
import 'MatrixColumn.dart';
import 'MatrixRow.dart';
import 'MatrixTypeSettings.dart';
import 'Nested.dart';
import 'NestedListTypeSettings.dart';
import 'Tab.dart';
...
class Specific {
  ...
  factory Specific.fromJson(Map<String, dynamic> json) {
    return Specific(
      ...
      fibFields: json['fibFields'] != null
          ? (json['fibFields'] as List).map((i) => Object).toList()
          : null,
      ...
      matrixColumns: json['matrixColumns'] != null
          ? (json['matrixColumns'] as List)
              .map((i) => MatrixColumn.fromJson(i))
              .toList()
          : null,
      matrixRows: json['matrixRows'] != null
          ? (json['matrixRows'] as List)
              .map((i) => MatrixRow.fromJson(i))
              .toList()
          : null,
      matrixType: json['matrixType'],
      matrixTypeSettings: json['matrixTypeSettings'] != null
          ? MatrixTypeSettings.fromJson(json['matrixTypeSettings'])
          : null,
      nestedList: json['nestedList'] != null
          ? (json['nestedList'] as List).map((i) => Nested.fromJson(i)).toList()
          : null,
      nestedListFieldType: json['nestedListFieldType'],
      nestedListItemsPerLine: json['nestedListItemsPerLine'] != null
          ? (json['nestedListItemsPerLine'] as List).map((i) => Object).toList()
          : null,
      nestedListMaxLevel: json['nestedListMaxLevel'],
      nestedListTypeSettings: json['nestedListTypeSettings'] != null
          ? NestedListTypeSettings.fromJson(json['nestedListTypeSettings'])
          : null,
      ...
      tabList: json['tabList'] != null
          ? (json['tabList'] as List).map((i) => Tab.fromJson(i)).toList()
          : null,
      tableColumns: json['tableColumns'] != null
          ? (json['tableColumns'] as List).map((i) => Object).toList()
          : null,
      tableFixedRowCount: json['tableFixedRowCount'],
      tableFixedRowLabels: json['tableFixedRowLabels'] != null
          ? (json['tableFixedRowLabels'] as List).map((i) => Object).toList()
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    data['repositoryField'] = this.repositoryField;
    data['repositoryFieldParent'] = this.repositoryFieldParent;
    ...
    if (this.fibFields != null) {
      data['fibFields'] = this.fibFields?.map((v) => v).toList();
    }
    ...
    if (this.nestedListItemsPerLine != null) {
      data['nestedListItemsPerLine'] =
          this.nestedListItemsPerLine?.map((v) => v).toList();
    }
    ...
    if (this.tableColumns != null) {
      data['tableColumns'] = this.tableColumns?.map((v) => v).toList();
    }
    if (this.tableFixedRowLabels != null) {
      data['tableFixedRowLabels'] =
          this.tableFixedRowLabels?.map((v) => v).toList();
    }
    return data;
  }
}
