...
class BatchWorkBlue extends StatefulWidget {
  final String sFolderName;
  final int iSelected; //hpgreenener

  const BatchWorkBlue({required this.sFolderName, required this.iSelected});

  @override
  _BatchWorkBlueState createState() =>
      _BatchWorkBlueState(sFolderName: sFolderName, iSelected: iSelected);
}

class _BatchWorkBlueState extends State<BatchWorkBlue> {
