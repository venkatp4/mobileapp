...
import 'ConnectItemInnerBlue.dart';

class ConnectSingleItemBlue extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            color: isSelected ? BrandColors.primary : Colors.purple.shade200,
